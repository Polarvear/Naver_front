...
<html>
	<head>
	  ...
	  <script>fbq('track', '<제휴사_수정본>');</script>		
	</head>
	<body>	
	<!--FORM START--------------------------------------------------------------------------------------------------------------------------------->
      <form name="form1" method="post">
       <input type=hidden name=unit value="e11">
		...
		<div class="container">
			<div class="wrap1" ><!----------wrap1 start------------>
				...
				<div class="top_desc">
					<p>* '상담신청' 메뉴를 이용하기 위해서는 먼저 아래 개인정보 수집 및 이용, 제3자 제공 및 위탁에 동의가 필요합니다.</p>
				</div>
				<hr/>
				
				<div class="top_dhl">
					<h4>㈜디에이치엘 코리아 개인정보 처리/취급방침 (V0.1)</h4>
		  ...
		  <tr valign="middle" height=50> 
            <td> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
				  <td align=center>
					<img src="../assets/images/al_btn_next.jpg" onclick="javascript:checkdata();">
				    <img src="../assets/images/al_btn_cancel.jpg">
				  </td>
                </tr>
              </table>
            </td>

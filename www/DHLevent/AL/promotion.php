...
<html>
	<head>
		...
		<style>
			...
			.wrap1{					
				background-image: url(../assets/images/al_home.jpg);
				height: 907px;
			...
			@media (max-width: 768px) {
				.wrap1{					
					...
					padding: 0; 
					padding-bottom: 79.2%; 
					background-image: url(../assets/images/al_mhome.jpg); 
	...
	<body>	
		<div class="container">
			...
			<div class="top_m_img">
			 	<img src="../assets/images/al_mhome_mod_text.jpg">
			 </div>

 ...
 /* contents */
	...
	<header id="header">
			...
			<div class="caption container">
				...
				<div class="subtitle">Do you need a faster and more accurate<br>overseas delivery service than anyone else?<br>Open a DHL Express Account now and get benefits for new customers!</div>
			</div>
		</header>
		<section id="promotion-new-consumer" class="promotion-new-consumer">
			<div class="container">
				...
				<div class="body row">
					<div class="col-sm-12">
						<img src="../assets/images/HP/en-promotion-desktop-1-5.png" class="img-responsive hidden-xs" alt="">
						<img src="../assets/images/HP/en-promotion-mobile-1-5.png" class="img-responsive visible-xs" alt="">
					</div>
					<div class="col-sm-12">
						<img src="../assets/images/HP/en-promotion-desktop-2-5.png" class="img-responsive hidden-xs" alt="">
						<img src="../assets/images/HP/en-promotion-mobile-2-5.png" class="img-responsive visible-xs" alt="">
					</div>
					<div class="col-sm-12">
						<img src="../assets/images/HP/en-promotion-desktop-3-2.png" class="img-responsive hidden-xs" alt="">
						<img src="../assets/images/HP/en-promotion-mobile-3-2.png" class="img-responsive visible-xs" alt="">
					</div>
				</div>
			</div>
		</section>
				...
				<div class="body row">
					<div class="col-sm-12">
						<ul style="margin-left:0px;">
							<li>
								...
								<span class="condtion-content">2022. 9.1 ~ 2022. 10.31</span>
							</li>
							<li>
							...
							<li>
								...
								<span class="condtion-content hidden-xs" style="padding-top:10px;">
									DHL Desk Pad will be given to those who open a DHL Express Account,<br>
									Crosby Green Siren Tumbler 355ml will be given to those who spend more than 100,000 won<br>
									Until next month after opening a DHL Express Account.
								</span>
							</li>
					...
					<div class="col-xs-12 description" style="display: block;">
						...
						<ul>
							...
							<li>Will be admitted to participate in the event, Only if having received this page within the promotion registration deadline.</li>
							<li>If do not agree to receive marketing information, will be excluded from the gift offer.</li>
							<li>The prize will be given only once during the event period and will be sent by courier.</li>
							<li>Gift for new customers is the DHL desk pad.</li>
							<li>The first shipping event gift is Starbucks Crosby Green Siren Tumbler 355ml.</li>
							<li>Starbucks tumbler can be replaced by prizes of the same price depending on inventory conditions.</li>
							<li>Customer who have completed their application for a DHL Express Account during the event period<br>will be eligible for a discount until December 31, 2022.</li>

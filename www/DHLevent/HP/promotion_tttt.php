...
<html>
 ...
 /* contents */
	...
	<header id="header">
			...
			<img src="../assets/images/HP/nav-desktop-2.png" alt="" class="img-responsive hidden-xs">
			<img src="../assets/images/HP/nav-mobile-2.png" alt="" class="img-responsive visible-xs">
			<div class="caption container">
				...
				<div class="subtitle">정기적인 물품 배송, 수입 진행이 있으신가요? <br/> DHL 고객 번호를 개설한 신규 고객 전원에게 50%할인 제공과 더불어 <br/>푸짐한 선물을 증정합니다.</div>
			</div>
		</header>
		<section id="promotion-new-consumer" class="promotion-new-consumer">
			<div class="container">
				...
				<div class="body row">
				<div class="col-sm-12">
						<img src="../assets/images/BG/promotion-desktop-1-2.png" class="img-responsive hidden-xs" alt="">
						<img src="../assets/images/BG/promotion-mobile-1-2.png" class="img-responsive visible-xs" alt="">
					</div>
					<div class="col-sm-12">
						<img src="../assets/images/BG/promotion-desktop-2-8.png" class="img-responsive hidden-xs" alt="">
						<img src="../assets/images/BG/promotion-mobile-2-8.png" class="img-responsive visible-xs" alt="">
					</div>
				</div>
			</div>
		</section>
		...
		<div class="message-box-wrap">
			...
			<div class="message-box">
				<div class="message-text">
					DHL 서비스에 대한 상담이 필요하신가요? 채팅상담 서비스로 쉽고 빠르게 문의하세요.
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="body row">
					<div class="col-sm-12">
						<ul style="margin-left:0px;">
							<li>
								...
								<span class="condtion-content">2022년 3월 1일~5월 31일까지</span>
							</li>
							<li>
							...
							<li style="padding-bottom:0px;">
								...
								<span class="condtion-content">
									이벤트 기간 내 본 페이지에서 고객번호를 개설한 모든 고객님께 2개월간 50% 할인율 제공,<br>
									고객번호 개설한 달의 익월까지 50만원 이상 이용 시 DHL 데스크테리어 세트 제공,<br>
									100만원 이상 이용 시 갤럭시 버즈2 100% 증정
								</span>
							</li>
							<div style="display:inline-table">
								<span class="li-span-mobile" style="display:inline-table;text-align:right;width:136.92px;">예&gt;</span>
								<span style="display:inline-table;padding:0 0 0 7px;">3월에 고객번호 개설 후 4월까지 120만원 이용 시 5월말 경 갤럭시버즈2 증정<br>4월에 고객번호 개설 후 5월까지 70만원 이용 시 6월말 경 DHL 데스크테리어 세트 증정<br>5월에 고객번호 개설 후 6월까지 200만원 이용 시 7월말 경 갤럭시버즈2 증정</span>
							</div>
					...
					<div class="col-xs-12 description" style="display: block;">
						<span>※</span> 유의사항<br>
						<ul>
							<li>이벤트 기간 내 고객번호를 개설한 모든 고객님께 2개월 동안 50% 할인율이 제공되며,<br>이후 영업사원과 상담 후 물량에 따라 조정될 수 있습니다.</li>
							<li>경품은 고객번호 개설 후 2개월 실적을 합산하며 3개월 차에 보내드립니다. (위 예시 참조)</li>
							<li>경품은 중복 지급이 불가하며 택배로 발송해 드립니다.</li>
							<li>갤럭시 버즈2 색상은 랜덤으로 지급됩니다.</li>
						</ul>
					</div>					
				</div>
			</div>

	...
	<body>
		<header id="header">
			...
			<div class="caption container">
				<div class="serises-name">DHL 블로그 프로모션</div>
				<div class="title hidden-xs">신규 고객님을 위한 50% 특별 할인</div>
				<div class="title visible-xs">신규 고객님을 위한 <br/> 50% 특별 할인</div>
				<div class="subtitle">정기적인 물품 배송, 수입 진행이 있으신가요?<br/>DHL 고객 번호를 개설한 신규 고객 전원에게<br/>최대 50%할인 제공 더불어 푸짐한 선물을 증정합니다.</div>
			</div>
		</header>
		<section id="promotion-new-consumer" class="promotion-new-consumer">
			<div class="container">
				...
				<div class="body row">
					<div class="col-sm-12">
						<img src="../assets/images/BG/promotion-desktop-1-3.png" class="img-responsive hidden-xs" alt="">
						<img src="../assets/images/BG/promotion-mobile-1-3.png" class="img-responsive visible-xs" alt="">
					</div>
					<div class="col-sm-12">
						<img src="../assets/images/BG/promotion-desktop-2-9.png" class="img-responsive hidden-xs" alt="">
						<img src="../assets/images/BG/promotion-mobile-2-9.png" class="img-responsive visible-xs" alt="">
					</div>
					<div class="col-sm-12">
						<img src="../assets/images/BG/promotion-desktop-3-3.png" class="img-responsive hidden-xs" alt="">
						<img src="../assets/images/BG/promotion-mobile-3-3.png" class="img-responsive visible-xs" alt="">
					</div>
				</div>
			</div>
		</section>
				...
				<div class="body row">
					<div class="col-sm-12">
						<ul style="margin-left:0px;">
							<li>
								...
								<span class="condtion-content">2022년 6월 1일~8월 31일까지</span>
							</li>
							<li>
							...
							<li style="padding-bottom:0px;">
								...
								<span class="condtion-content">
									...
									고객번호 개설한 달의 익월까지 10만원 이상 이용 시 DHL 홈트레이닝 세트 증정,<br>
									고객번호 개설한 달의 익월까지 50만원 이상 이용 시 DHL 골프공 세트 추가 증정
								</span>
							</li>
					...
					<div class="col-xs-12 description" style="display: block;">
						...
						<ul>
							...
							<li>경품은 고객번호 개설한 달을 포함한 2개월 실적을 합산하며 3개월 차에 보내 드립니다. (위 예시 참조)</li>
							<li>50만원 이상 이용 시 DHL 홈트레이닝 세트와 골프공 세트 모두 증정합니다. (택배 발송)</li>
							<li>DHL 홈트레이닝 세트는 아령1KG 2개, 짐볼, 마사지볼, 루프밴드 5종으로 구성됩니다.</li>
							<li>DHL 골프공 세트는 볼빅 비비드 무광 골프공 6구, 볼마커, 클립으로 구성됩니다.</li>
						</ul>
					</div>					
				</div>
			</div>
		...
		<section class="promotion-form">
			<div class="container" style="width: 100%;">
				<script src="https://ionfiles.scribblecdn.net/scripts/ionizer-1.3.min.js" data-ion-embed-hash="eyJ1cmwiOiIvL3NoaXBwaW5nLmRobC5jby5rci9OQVZFUkJMT0cyMDIxP19pb25fdGFyZ2V0PWVtYmVkLTEuMCIsImlkIjoiX2lvbl9pb25pemVyXzE2MjI2ODg1NDcxMjQiLCJhcHBlbmRRdWVyeSI6ZmFsc2V9"></script>
			</div>
		</section>

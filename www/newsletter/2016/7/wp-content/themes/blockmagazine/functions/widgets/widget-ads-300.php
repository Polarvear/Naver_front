...
class AdWidget_300 extends WP_Widget {
	...
	function AdWidget_300() {
		...
		parent::__construct(false, __('Themnific - Ads Widget 300px/Free', 'themnific'),$widget_ops);      
	}
	...
	function widget($args, $instance) {  
		...
		<?php } else { ?>
			...
			<a target="_blank" href="<?php echo $href; ?>"><img src="<?php echo $image; ?>" alt="<?php echo $alt; ?>" /></a>

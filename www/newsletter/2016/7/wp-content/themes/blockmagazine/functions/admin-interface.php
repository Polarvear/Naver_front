...
function themnificthemes_machine($options) {
	...
	foreach ($options as $value) {
		...
		case "typography":
			...
			if (strpos($val, 'Roboto Slab') !== false){ $font59 = 'selected="selected"'; }
			if (strpos($val, 'Courier') !== false){ $font60 = 'selected="selected"'; }
			...
			$output .= '<option value="Courier"'. $font60 .'>Courier</option>';
			...
			$output .= '<option value="Roboto Slab"'. $font59 .'>Roboto Slab***</option>';

...
class Facebook_Widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
    	...
    	<div class="twinsbox">
			<h2 class="widget">
				<a class="rsswidget">
					<img class="rss-widget-icon" style="border:0" width="14" height="14" src="http://www.dhlkorea.com/newsletter/2016/7/wp-includes/images/facebook.png" alt="DHL facebook" />
				</a>
				<a class="rsswidget" href="https://www.facebook.com/DHLExpressKorea/" target="_blank">DHL Korea 공식 페이스북</a>
			</h2>
		<?php
		// if($title) {

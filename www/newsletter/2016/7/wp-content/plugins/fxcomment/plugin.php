 ...
 */
	...
	*/
	if($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		header('Location: http://www.dhlkorea.com/newsletter/2016/7/event');
						...
						<div>
							...
							<div class="form-parent">
                                ...
                                <div class="modify-form-area" style="display:none;">
    								<form class="modify-form" action="<?php echo $_SERVER['REQUEST_URI']?>" method="POST" name="modify-form">
    									<div>
	...
	if(!function_exists('fx_comment_custom_fields')) {
		function fx_comment_custom_fields($fields) {
		  ...
		  $fields[ 'password' ] = '<p class="comment-form-password">'.
			'<label for="fx-comment-password">' . ( $req ? '<span class="required">*</span>' : '' ) . __( 'Password' ).' ( 댓글 수정 및 확인 시 필요합니다. )' . '</label>'. 

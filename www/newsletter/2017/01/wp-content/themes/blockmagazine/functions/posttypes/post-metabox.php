...
$meta_box = array(
    ...
    'fields' => array(
		...
		array(
			'name' => '',
			'desc' => 'Post Size & Shape on Homepage',
			'id' => $prefix . 'main_rating',
			'type' => 'heading',
			'std' => ''
		),
				...
				array(
					'name' => 'Post Size & Shape',
					'desc' => '',
					'id' => $prefix . 'size-shape',
					'type' => 'select',
					'std' => '',
					'options' => array('Normal','Big','Vertical','Horizontal')
				),	
		...
		array(
			...
			'std' => ''
				...
				array(
					'name' => 'Video',
					'desc' => 'Enter iframe video code - 820px width.  ',
					'id' => $prefix . 'video',
					'type' => 'textarea',
					'std' => ''
				),
...
function mytheme_show_box() {
    ...
    foreach ($meta_box['fields'] as $field) {
        ...
        switch ($field['type']) {
            ...
            case 'heading':
                echo '<h3 id="', $field['id'], '" class="meta" style=" margin-top:40px; background-color:#eee;">'; echo $field['desc']; echo '</h3>';
                break;

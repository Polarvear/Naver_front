...
<!-- <a id="navtrigger-sec" href="#"><?php _e('MENU','themnific');?></a>
	...
	<div id="topnav" class="container" style="margin-top:20px;margin-bottom:20px;">
		<span>TOP Navigator 주석처리 합니다.</span>
	...
	<div id="topnav" class="container container_alt">
		...
		<div class="dropdown" style="margin: 15px 0 14px 2px;border: 1px solid #e3e3e3;">
			...
			<div id="myDropdown" class="dropdown-content" style="width: 200px;text-align:center;font-size:12px;background-color:#FFFFFF">
			    <a href="http://dhlkorea.com/newsletter/2016/4">2016년 4월호</a>
			    <a href="http://dhlkorea.com/newsletter/2016/7">2016년 7월호</a>
				<a href="http://dhlkorea.com/newsletter/2016/10">2016년 10월호</a>

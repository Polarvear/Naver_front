...
<head>
  ...
  <title>2015 DHL B2C기업 지원 세미나</title>
	<!--[if lt IE 9]>
...
<body>
	...
	<section id="container">
		...
		<div style="width:100%">
			<img width=100% src="images/header_1.jpg">
		</div>
		
		<form name="hongkiat" id="hongkiat-form" method="get" action="b2cNewinsert.php"  onSubmit="CheckValues();return false">

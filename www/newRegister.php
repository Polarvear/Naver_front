...
<head>
  ...
  <link rel="stylesheet" type="text/css" media="all" href="responsive.css">
	...
	if (CheckSpaces(document.hongkiat.coName.value)){ 
			...
			document.hongkiat.coName.focus(); 
...
<body>
	...
	<section id="container">
		...
		<div id="headImg"></div>		
		<form name="hongkiat" id="hongkiat-form" method="get" action="ftaNewinsert.php"  onSubmit="CheckValues();return false">
		
		<div id="wrapping" class="clearfix">
			<section id="aligned">
			
				<input type="text" name="coName" 	id="coName" placeholder="회사이름" autocomplete="off" tabindex="1" class="txtinput">
				...
				<input type="text" name="cContact" 	id="cContact" placeholder="휴대전화번호" 	tabindex="4" class="txtinput">
				...
				<section id="aside" class="clearfix">
							...
							<h2>주요글로벌 비즈니스</h2>
								...
								<h3>수출입 물량</h3>		
									<div class="inputSmall">월 <input type="text" name="coSize" 	id="coSize" class="txtinput_num"> 건</div>
